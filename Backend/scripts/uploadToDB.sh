...
REL_TESTDIR="../tests/"
REL_TESTSETTINGSDIR=$"${REL_TESTDIR}settings/"
TEST_POPDB_SETTINGS="${REL_TESTSETTINGSDIR}populateDB_settings.txt"
TEST_UPLOADTODB_SETTINGS="${REL_TESTSETTINGSDIR}uploadToDB_settings.txt"
...
function checkSettings(){
   ...
   printf "\tREL_TESTDIR: %s\n" "$REL_TESTDIR"
   printf "\tREL_TESTSETTINGSDIR: %s\n" "$REL_TESTSETTINGSDIR"
